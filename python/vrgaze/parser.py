...
def get_args_parser():
	...
	parser.add_argument('--list_subject_names', type=str, nargs='+', default=[], help="List subject names manually")

	# Scene Information
	parser.add_argument('--scene_length', type=int, default=16, help="Amount of time people spent in each scene")
...
def set_paths(args):
	...
	paths = {
		...
		'project_fix_pkl_dir': project_fix_pkl_dir,
